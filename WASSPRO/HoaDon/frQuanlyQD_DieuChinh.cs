...
{
    public partial class frQuanlyQD_DieuChinh : Form
    {
        CAPNUOC_TNCEntities db = new CAPNUOC_TNCEntities();
        decimal QDID;
        DataTable table;
        public frQuanlyQD_DieuChinh()
        {
            InitializeComponent();
        ...
        void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (nguoidung.isLock == false)
            {
                ...
                if (yeucauDC.isdaduyet == true)
                    MessageBox.Show("Hóa đơn này đã điều chỉnh!");
                else if (yeucauDC.tongtien_DC == 0)
                    MessageBox.Show("Chưa nhập số tiền điều chỉnh!");
                else
                {
                                ...
                                if (result.Substring(0, 2) == "OK")
                                {
                                    ...
                                    if (result1 == "TRUE")
                                    {
                                        ...
                                        if (pResult_TH == "TRUE")
                                        {
                                            ...
                                            MessageBox.Show(Arr_result[0].ToString().ToUpper() + Arr_result[1].ToString().ToUpper());
                                    }
                                    else
                ...
                MessageBox.Show("Hệ thống đang phát hành hóa đơn!");
        }
        ...
        void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (yeucauDC.isdaduyet == true)
                MessageBox.Show("Hóa đơn đã thanh toán hoặc đã điều chỉnh hóa đơn điện tử, không thể xóa!");
            else
            {
        ...
        void btnInDS_Click(object sender, EventArgs e)
        {
            int trangthai = 2;
            ...
            DSDIEUCHINHHOADON frm = new DSDIEUCHINHHOADON();
            ...
            frm.text = txtTim.Text.Replace(" ", String.Empty);
            frm.Show();
        }

        void btnIn_Click(object sender, EventArgs e)
        {
            frQuyetDinhDieuChinh frm = new frQuyetDinhDieuChinh();
            frm.QDID = QDID;
            frm.MdiParent = this.MdiParent;
            foreach (Form otherForm in this.MdiChildren)
                if (otherForm != frm)
        ...
        void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                frCapNhatQĐieuChinh frm = new frCapNhatQĐieuChinh();
                frm.QDID = QDID;
                frm.MdiParent = this.MdiParent;
                foreach (Form otherForm in this.MdiChildren)
                    if (otherForm != frm)
