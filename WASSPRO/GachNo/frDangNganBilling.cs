...
{
    public partial class frDangNganBilling : Form
    {
        CAPNUOC_TNCEntities db = new CAPNUOC_TNCEntities();
        public frDangNganBilling()
        {
            InitializeComponent();
        ...
        private void frDangNganBilling_Load(object sender, EventArgs e)
        {
            ...
            cboKSV.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.FileName != "")
            {
                ...
                MessageBox.Show("Đăng ngân thành công!");
            }
        }
    }
}
