...
{
    public partial class frGachNo_Excel : Form
    {
        CAPNUOC_TNCEntities db = new CAPNUOC_TNCEntities();
        public frGachNo_Excel()
        {
            InitializeComponent();
        ...
        void btnformexcel_Click(object sender, EventArgs e)
        {
          
        }

        void btnExcelFail_Click(object sender, EventArgs e)
        {
        ...
        void btnKiemtra_Click(object sender, EventArgs e)
        {
            //try
            //{
        ...
        public static DataTable Fdt_Excel(string pathExcel, string sheetName)
        {
                ...
                using (DbConnection connection = factory.CreateConnection())
                {
                    ...
                    using (DbCommand command = connection.CreateCommand())
                    {
                        try
                        {
                            ...
                            {
                                MessageBox.Show("Nhập đúng tên sheet chứa dữ liệu hóa đơn phát hành.");
                                return null;
                            }
            ...
            {
                MessageBox.Show("File không đúng định dạng"  + ex.ToString());
            }
            return b_dt_kq;
        }
