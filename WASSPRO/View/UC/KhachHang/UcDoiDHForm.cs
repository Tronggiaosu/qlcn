...
namespace QLCongNo
{
    public partial class UcDoiDHForm : View.Core.NovUserControl
    {
        ...
        private void DoiDHForm_Load(object sender, EventArgs e)
        {
            LoadHTTT();
            LoadLT();           
            LoadNN();
        ...
        private void editButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                db.YEUCAUs.Add(yc);
                db.SaveChanges();
                MessageBox.Show("Tạo yêu cầu đổi đồng hồ thành công!", "Thông báo");
            }
            catch { }
        }
