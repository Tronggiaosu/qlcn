...
namespace QLCongNo
{
    public partial class UcSuaChuaForm : View.Core.NovUserControl
    {
        CAPNUOC_TNCEntities db = new CAPNUOC_TNCEntities();
        public decimal id_kh = 0;
        public UcSuaChuaForm()
        {
            InitializeComponent();
        }

        private void SuaChuaForm_Load(object sender, EventArgs e)
        {
            LoadHTTT();
            LoadLT();
            LoadNN();
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            db.YEUCAUs.Add(yc);
            db.SaveChanges();
            MessageBox.Show("Tạo yêu cầu sửa chữa thành công!", "Thông báo");
        }
    }
}
