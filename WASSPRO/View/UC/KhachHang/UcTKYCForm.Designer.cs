namespace QLCongNo
{
    partial class UcTKYCForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UcTKYCForm));
            ...
            this.ttcheckBox = new View.Core.NovCheckBox();
            this.loaiYCcheckBox = new View.Core.NovCheckBox();
            ...
            this.ttcomboBox = new View.Core.NovComboBox();
            this.yccomboBox = new View.Core.NovComboBox();
            this.dataGridView1 = new View.Core.NovDataGridView();
            this.sttColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.sophieuColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.dbColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.hotenColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.ycColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.ngayycColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.ngayHTColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.nguoiTHColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.ttColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.diachi1Column = new View.Core.NovDataGridViewTextBoxColumn();
            this.sdtColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.loaiKHColumn = new View.Core.NovDataGridViewTextBoxColumn();
            this.clmGhiChu = new View.Core.NovDataGridViewTextBoxColumn();
            this.idYCColumn = new View.Core.NovDataGridViewTextBoxColumn();
        ...
        private View.Core.NovCheckBox loaiYCcheckBox;
        ...
        private View.Core.NovCheckBox ttcheckBox;
        private View.Core.NovComboBox ttcomboBox;
        private View.Core.NovDataGridViewTextBoxColumn sttColumn;
        private View.Core.NovDataGridViewTextBoxColumn sophieuColumn;
        private View.Core.NovDataGridViewTextBoxColumn dbColumn;
        ...
        private View.Core.NovDataGridViewTextBoxColumn ngayHTColumn;
        private View.Core.NovDataGridViewTextBoxColumn nguoiTHColumn;
        private View.Core.NovDataGridViewTextBoxColumn ttColumn;
        private View.Core.NovDataGridViewTextBoxColumn diachi1Column;
        private View.Core.NovDataGridViewTextBoxColumn sdtColumn;
        private View.Core.NovDataGridViewTextBoxColumn loaiKHColumn;
        private View.Core.NovDataGridViewTextBoxColumn clmGhiChu;
        private View.Core.NovDataGridViewTextBoxColumn idYCColumn;
    }
}