...
namespace QLCongNo
{
    public partial class UcKiemTraForm : View.Core.NovUserControl
    {
        CAPNUOC_TNCEntities db = new CAPNUOC_TNCEntities();
        public decimal id_kh = 0;
        public UcKiemTraForm()
        {
            InitializeComponent();
        }
        private void KiemTraForm_Load(object sender, EventArgs e)
        {
            LoadHTTT();
            LoadLT();
            LoadNN();
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            db.YEUCAUs.Add(yc);
            db.SaveChanges();
            MessageBox.Show("Tạo yêu cầu thành công!", "Thông báo");
        }
    }
}
