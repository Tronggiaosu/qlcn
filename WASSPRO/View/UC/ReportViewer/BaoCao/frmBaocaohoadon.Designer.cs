namespace QLCongNo.View.UC.ReportViewer.BaoCao
{
    partial class UcBaocaohoadon
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dtptungay = new View.Core.NovDateTimePicker();
            this.groupBox1 = new View.Core.NovGroupBox();
            this.cboDenky = new View.Core.NovComboBox();
            this.cboTuky = new View.Core.NovComboBox();
            this.label3 = new View.Core.NovLabel();
            this.label2 = new View.Core.NovLabel();
            this.label1 = new View.Core.NovLabel();
            this.btnXembaocao = new View.Core.NovButton();
            this.cbochonloaibaocao = new View.Core.NovComboBox();
        ...
        private View.Core.Nov groupBox2;
        ...
        private View.Core.NovButton btnXembaocao;
        private View.Core.NovComboBox  cbochonloaibaocao;
