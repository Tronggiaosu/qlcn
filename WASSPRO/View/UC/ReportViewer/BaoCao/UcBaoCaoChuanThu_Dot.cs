...
{
    public partial class UcBaoCaoChuanThu_Dot : View.Core.NovUserControl
    {
        CAPNUOC_TNCEntities db = new CAPNUOC_TNCEntities();
        public UcBaoCaoChuanThu_Dot()
        {
            InitializeComponent();
        ...
        void btnTim_Click(object sender, EventArgs e)
        {
            ...
            var root = "ReportViewer\\ReportView\\RPBaoCaoChiaTheoDot.rdlc";
            ...
            var dataSource = db.getBaoCaoChuanThuDot(0, result, TOID).ToList();
