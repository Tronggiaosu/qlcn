namespace QLCongNo.View.UC.HeThong
{
    partial class UcChangePassForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UcChangePassForm));
            ...
            this.txtUsername = new View.Core.NovTextBox();
            this.txtRetype = new View.Core.NovTextBox();
            this.txtNewPassword = new View.Core.NovTextBox();
            this.txtPassword = new View.Core.NovTextBox();
            this.closeButton = new View.Core.NovButton();
            this.okButton = new View.Core.NovButton();
            this.SuspendLayout();
            // 
            // label3
            // 
