...
{
    public partial class UcDongBoThanhToanEx : View.Core.NovUserControl
    {
        private CAPNUOC_TNCEntities db = new CAPNUOC_TNCEntities();

        public UcDongBoThanhToanEx()
        {
            InitializeComponent();
        }
        ...
        private void btnDB_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Chưa có dữ liệu để cập nhật!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return; 
                }
